...
palabras = ["hola", "mundo", "juego", "zoologico"]
letras_correctas = []
letras_incorrectas = []
intentos = 6
aciertos = 0
...
def pedir_letra():
    ...
    while not es_valida:
        ...
        if letra_elegida.isalpha() and len(letra_elegida) == 1:
            es_valida = True
        else:
...
while not juego_terminado:
    ...
    print('\n' + '*' * 20 + "\n")
    letter = pedir_letra()
    intentos, terminado, aciertos = chequear_letra(letter, palabra, intentos, aciertos)
